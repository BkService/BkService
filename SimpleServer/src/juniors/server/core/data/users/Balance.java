...
/**
 * Класс для хранения финансовой информации. Содержит 2 поля для финансовой
 * информации. Одно поле для хранения доступного счёта, другое - для хранения
 * резерва. В резерве сохраняется id ставки и сумма ставки, которая вычитается
 * из доступных средств. Так же для организации транзакций добавлена блокировка
 * баланса
 * 
 * @author kovalev
 * 
...
public class Balance {
	...
	/**
	 *  Returns true if a user has any actives(available or he can active bets).
	 *  @autor watson 
	 */
	public boolean isBankrupt()  {
		...
		return ((available == 0) && reserve.isEmpty());
	}
